...
const QrCodeReader = forwardRef<QrCodeReaderRef, QrCodeReaderProps>((props, ref) => {
  ...
  return (
    <DrawerComponent trigger={props.children} ref={drawerRef} onClose={onClose} onOpen={onOpen}>
      {isOpen && (
        <Scanner
          components={{
            audio: false,

...
import DrawerComponent, { DrawerComponentProps, DrawerComponentRef } from "../DrawerComponent";
...
const ConfirmByPasscode = forwardRef<ConfirmByPasscodeRef, ConfirmByPasscodeProps>(
  (props: ConfirmByPasscodeProps, ref) => {
    ...
    return (
      <DrawerComponent ref={drawerRef} trigger={props.children} onOpen={handleOnOpen} onClose={handleOnClose}>
        <LoadingLayout
          initLoading={false}
          ref={loadingRef}
          sx={{
        ...
        >
          <ModalLayout title={"Authentication"} onClose={handleClose}>
            ...
            >
              ...
              >
                Enter your passcode to confirm <Text sx={{ fontWeight: theme.typography.fontWeight600 }}>{action}</Text>
              </Text>
              <OTP
                value={otp}

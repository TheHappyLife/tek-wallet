...
const sendExternalService = async (body: SendExternalBody): Promise<SendExternalResponse> => {
  const response = await userClientRequest.post("/transaction/withdrawn", body, {
    headers: {
